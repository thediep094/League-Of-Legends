    ...
    <div className="featured">
      ...
      <div className="videoTheGame">
          <div className="videoTheGame__container">
            <video className="video" src={process.env.PUBLIC_URL + '/VideoBG/howtoplay.mp4'} autoPlay muted loop></video>
            ...
            <div className="videoTheGame__container--text">
              ...
              <p>League of Legends is a team-based strategy game 
                where two teams of five powerful champions face 
                off to destroy the other’s base. 
                Choose from over 140 champions to make epic plays, 
                secure kills, and take down towers as you battle 

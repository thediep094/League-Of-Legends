import './theChampion.scss'
import './theChampion.css'
import { theChampion } from '../../data/theChampion'
import { useEffect, useState } from 'react'
import {CSSTransition, TransitionGroup} from 'react-transition-group'
import Aos from 'aos'
const TheChampion = () => {
    const [champion, setChampion] = useState(Math.floor(Math.random() * theChampion.length))
    const handleClick = () => {
        if(champion < theChampion.length - 1 ){
            setTimeout(setChampion(champion + 1),1000)
        }
        else{
            setTimeout(setChampion(0),1000)
        }
    ...
    <div className="thechampion">
        <TransitionGroup>
            ...
            <CSSTransition classNames="fade" key={champion} timeout={2000}> 
                <div className="thechampion__container"
                style={{ 
                    ...
                    <div className="thechampion__container__champ">
                        <div className="info">
                            ...
                            <div className="role__lane">
                                <div className="role">
                                    <span>ROLE</span>
                                    <img src={process.env.PUBLIC_URL + theChampion[champion].role} alt="" />
                                </div>
                                <div className="lane">
                                    <span>SUGGESTED LANE</span>
                                    <img src={process.env.PUBLIC_URL + theChampion[champion].lane} alt="" />
                                </div>
                            </div>
                        ...
                        <div className="thechampion__container__img">
                            <img src={process.env.PUBLIC_URL + theChampion[champion].img} alt="" />
                        </div>
